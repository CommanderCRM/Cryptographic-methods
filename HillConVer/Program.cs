...
namespace HillConVer
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Реализация шифра Хилла.");
            while (true)
            {
                while (true)
                {
                ...
                while (true)
                {
                    Console.WriteLine("1 - обычный шифр Хилла, 2 - рекуррентный шифр Хилла");
                    try
                    {
                ...
                while (true)
                {
                    ...
                    if(method == 1)
                        if (determ(key_old) != 0)
                            ...
                            Console.WriteLine("Повторите ввод, определитель равен нулю");
                    else
