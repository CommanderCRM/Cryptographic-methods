    ...
    public partial class Form1 : Form
    {
        ...
        private void buttonEncrypt_Click(object sender, EventArgs e)
        {
            if ((textBox_p.Text.Length > 0) && (textBox_q.Text.Length > 0))
            {
                ...
                if (IsTheNumberSimple(p) && IsTheNumberSimple(q))
                {
                    ...
                    List<string> result = RSA_crypt(s, d, n);
        ...
        private void buttonDecipher_Click(object sender, EventArgs e)
        {
            if ((textBox_d.Text.Length > 0) && (textBox_n.Text.Length > 0))
            {
                ...
                long e_ = Convert.ToInt64(textBox_d.Text);
                ...
                string result = RSA_decrypt(input, e_, n);
        ...
        //зашифровать
        private List<string> RSA_crypt(string s, long d, long n)
        {
        ...
        //расшифровать
        private string RSA_decrypt(List<string> input, long e, long n)
        {
            string result = "";
